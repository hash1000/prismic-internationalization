...
/**
 * Props for `Disclaimer`.
 */
export type DisclaimerProps = SliceComponentProps<Content.DisclaimerSlice>;

/**
 * Component for "Disclaimer" Slices.
 */
const Disclaimer: FC<DisclaimerProps> = ({ slice }) => {
  return (
        <>
          <Bounded
          ...
          >
            <div className="max-w-7xl mx-auto pt-[150px] pb-[50px]">
              ...
              <section>
                ...
                {slice.primary.disclaimer.map((item, index) => (
                  <div key={index}>
                    <PrismicRichText
                      field={item.heading}
                      components={{
